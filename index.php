...
<body>
    ...
    <div class="container">
        <div class="col-lg-12">
            <img src="asset/img/smart.gif" alt="Smart" class="img-responsive"/>
        </div>
    </div>
       ...
       <div class="row">
           ...
           <div class="col-md-3" >
               <div class="panel panel-default" style="margin-top: 10px;">
                   ...
                   <div class="panel panel-body">
                       <div style="list-style: none">
                           <img src="asset/img/im.png" alt="Image" class="img-responsive img-thumbnail"/>
                       </div>
                   </div>
               </div>
...
<!--            <h5 style="text-align: center">&copy;Copy right 2014</h5>-->
            <div class=" pull-right">&copy;Copy right 2014</div>
